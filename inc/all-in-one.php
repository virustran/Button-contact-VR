<!--  * Version: 3.0 -->
<div class="wrap">
<h2>All in one (beta)</h2>
<h2 class="nav-tab-wrapper">
    <a href="admin.php?page=contact_vr" class="nav-tab">Button contact</a>
    <a href="admin.php?page=contact_vr_all_in_one" class="nav-tab  nav-tab-active">All in one (beta)</a>
    <a href="admin.php?page=contact_vr_setting" class="nav-tab">Button contact</a>
</h2>
